...
public class HashUtil {
    ...
    public static void main(String[] args) {
        String srt = "南京江北区拆迁合同的撒发生的发生大发生的发生地方";
        String srt1 = "asdf";
        String srt2 = "asdfasdf";
        String srt3 = "南京江北区拆迁合同sadfasdfas";
        System.out.println(tianlHash(srt));
        System.out.println(tianlHash(srt1));
        System.out.println(tianlHash(srt2));
        System.out.println(tianlHash(srt3));
    }
