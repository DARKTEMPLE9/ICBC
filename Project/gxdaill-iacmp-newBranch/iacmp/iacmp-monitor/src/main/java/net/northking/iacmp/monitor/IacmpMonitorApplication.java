package net.northking.iacmp.monitor;
...
public class IacmpMonitorApplication {

    public static void main(String[] args) {
        log.debug("IacmpMonitorApplication startup main");
        SpringApplication application = new SpringApplication(IacmpMonitorApplication.class);
