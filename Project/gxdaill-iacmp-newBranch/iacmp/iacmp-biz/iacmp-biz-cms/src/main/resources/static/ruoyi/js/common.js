...
$(function () {
    ...
    // laydate 时间控件单个时间带时分秒绑定
    if ($(".select-time").length > 0) {
        layui.use('laydate', function () {
            var laydate = layui.laydate;
            var singleTimehms = laydate.render({
                elem: '#singleTimehms',
                max: 0,
                theme: 'molv',
                trigger: 'click',
