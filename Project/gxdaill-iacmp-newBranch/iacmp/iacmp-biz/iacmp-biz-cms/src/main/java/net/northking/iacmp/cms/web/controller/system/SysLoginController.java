...
import net.northking.iacmp.cms.web.sso.service.TokenAuthService;
import net.northking.iacmp.cms.web.sso.service.UserInfoService;
...
//        String remoteAddr = ServletUtils.getRequest().getRemoteAddr();
        ...
        try {
            ...
            for (int i=0;i<addrs.length;i++){
                ...
                TokenAuthResponse tokenAuthResponse = tokenAuthService.verifyToken(code, ssoToken, "cms", addr, false, true);
                ...
                if (!BCGSSO.equals(retCode) ) {
                    ...
                    if (user == null){      //用户不存在，同步用户
                        UserInfoResponse userInfoRsp = userInfoService.queryUserInfo(code, "cms");
