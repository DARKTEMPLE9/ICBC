...
import net.northking.iacmp.system.domain.SysRoleMenu;
...
public class SysRoleServiceImpl implements ISysRoleService {
     ...
     */
    @Override
    public List<String> selectRoleDeptByUserId(Long userId) {
        return roleDeptMapper.selectRoleDeptByUserId(userId);
    }
