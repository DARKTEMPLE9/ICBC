...
import net.northking.iacmp.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
     ...
     */
    @Override
    public List<SysMenu> selectMenusByRoles(String[] ids) {
        List<SysMenu> menus;
        //
        menus = menuMapper.selectMenusByRoles(ids);
        return getChildPerms(menus, 0);
    }
     ...
     */
    @Override
    public List<SysMenu> selectMenusByRole(Long roleId) {
        return menuMapper.selectMenusByRole(roleId);
    }
}
