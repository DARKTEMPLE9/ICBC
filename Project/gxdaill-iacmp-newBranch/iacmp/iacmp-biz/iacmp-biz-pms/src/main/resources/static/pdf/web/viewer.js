    ...
    (function () {
        ...
        (function (root, factory) {
            ...
            function parseQueryString(query) {
                ...
                debugger;
                var params = {};
                var paramsFile = query.substring(0, 4);
                var paramsFileUrl = query.substring(5, query.length);
                params[decodeURIComponent(paramsFile)] = decodeURIComponent(paramsFileUrl);
                return params;
            }
                ...
                PasswordPrompt.prototype = {
                    open: function PasswordPrompt_open() {
                        OverlayManager.open(this.overlayName).then(function () {
                            ...
                            this.input.focus();
                            var promptString = mozL10n.get('password_label', null, 'Enter the password to open this PDF util.');
        ...
        (function (root, factory) {
                ...
                open: function pdfViewOpen(file, args) {
                    ...
                    return loadingTask.promise.then(function getDocumentCallback(pdfDocument) {
                        ...
                        if (exception instanceof pdfjsLib.InvalidPDFException) {
                            loadingErrorMessage = mozL10n.get('invalid_file_error', null, 'Invalid or corrupted PDF util.');
                        } else if (exception instanceof pdfjsLib.MissingPDFException) {
                            loadingErrorMessage = mozL10n.get('missing_file_error', null, 'Missing PDF util.');
                    ...
                    if (moreInfo) {
                        ...
                        if (moreInfo.stack) {
                            ...
                            if (moreInfo.filename) {
                                moreInfoText += '\n' + mozL10n.get('error_file', {file: moreInfo.filename}, 'File: {{util}}');
                            }
            ...
            validateFileURL = function validateFileURL(file) {
                try {
                    ...
                    if (fileOrigin !== viewerOrigin) {
                        throw new Error('util origin does not match viewer\'s');
                    }
                } catch (e) {
            ...
            webViewerOpenFileViaURL = function webViewerOpenFileViaURL(file) {
                if (file && file.lastIndexOf('util:', 0) === 0) {
