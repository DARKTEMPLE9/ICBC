package net.northking.iacmp.utils.rsa;
 ...
 * 非对称加密算法RSA算法组件
 *
 * @Description: 非对称算法一般是用来传送对称加密算法的密钥来使用的，相对于DH算法，RSA算法只需要一方构造密钥，不需要
...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = "air,2582dd863c1c50525a267e1cbe656929,41323812591652864";

        System.out.println("原文:" + str);

        //乙方使用公钥对数据进行加密
        byte[] code2 = encryptByPublicKey(Base64.encodeBase64(str.getBytes()), Base64.decodeBase64("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCODtW+O+j7s1UQDNf3hy2vyrRnvdGrrsvuOTfsAvszAcKKuP45QSmqiGMxrtx4hatVKySXGD2kX1pHujJgZRuIamNtkwpx/ihIa29ZvDnbBx9KH2A5+YUZiE22Vf3Vr8pK8S3bzHzg2i7DkcgZiuZyV0MhCEggIJ2VjDYPj/VHyQIDAQAB"));
