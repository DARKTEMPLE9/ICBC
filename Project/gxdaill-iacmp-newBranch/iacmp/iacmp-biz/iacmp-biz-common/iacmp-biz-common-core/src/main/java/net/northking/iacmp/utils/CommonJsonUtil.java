...
public class CommonJsonUtil {
    private Logger log = LoggerFactory.getLogger(CommonJsonUtil.class);

    private static volatile CommonJsonUtil instance;

    private CommonJsonUtil() {
    }

    public static CommonJsonUtil get() {
        if (instance == null) {
            synchronized (CommonJsonUtil.class) {
                if (instance == null) {
                    instance = new CommonJsonUtil();
                }
            }
        }
        return instance;
