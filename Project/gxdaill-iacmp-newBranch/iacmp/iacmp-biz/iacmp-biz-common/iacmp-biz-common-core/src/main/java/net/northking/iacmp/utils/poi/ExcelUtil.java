package net.northking.iacmp.utils.poi;
...
import net.northking.iacmp.annotation.Excel.Type;
...
import net.northking.iacmp.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
     ...
     * 注解列表
     */
    private transient List<Object[]> fields;
    ...
    public void createSheet(double sheetNo, int index) {
        ...
        // 设置工作表的名称.
        if (Double.doubleToLongBits(sheetNo) == new Long(0)) {
