package net.northking.iacmp.utils.file;
...
import net.northking.iacmp.execption.file.FileNameLengthLimitExceededException;
import net.northking.iacmp.execption.file.FileSizeLimitExceededException;
...
public class FileUploadUtils {
     ...
     * 默认大小 50M
     */
    public static final long DEFAULT_MAX_SIZE = (long) 50 * 1024 * 1024;
    ...
    private static final File getAbsoluteFile(String uploadDir, String fileName) throws Exception {
        ...
        if (!desc.exists()) {
            boolean tag = desc.createNewFile();
            if (tag == false) {
