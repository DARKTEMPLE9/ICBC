...
public class UserConstants {
     ...
     * 模型名称是否唯一的返回结果码
     */
    public static final String MODEL_NAME_UNIQUE = "0";
    public static final String MODEL_NAME_NOT_UNIQUE = "1";
    /**
     * 模型编码是否唯一的返回结果码
     */
    public static final String MODEL_CODE_UNIQUE = "0";
    public static final String MODEL_CODE_NOT_UNIQUE = "1";
    /**
     * 岗位名称是否唯一的返回结果码
     */
