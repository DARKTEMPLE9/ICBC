 ...
 */
@Data
public class AmsBatchDTO4Impt extends BaseEntity {
...
//    @Excel(name = "创建人号")
     ...
     * 形成日期
     */
    @Excel(name = "形成日期", dateFormat = "yyyy-MM-dd", prompt = "输入日期格式如：2019-08-01")
...
//    @Excel(name = "移交时间")
     ...
     * 是否移交行档室
     */
    @Excel(name = "是否移交行档室", readConverterExp = "0=否,1=是", combo = {"是", "否"})
