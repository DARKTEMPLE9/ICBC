...
(function () {
    var Provider, nIdCount = 0, aOtherBrowsers = ["Maxthon", "SE 2.X", "QQBrowser"],
        ...
        sTotalContainer = '<div id="#totalContainerId#" class="stream-total-tips">' +
            ...
            '</div>',
        cancelContainer = '<div id="#totalContainerId#" class="stream-total-tips">' +
            '<a onclick="allCancel()" style="text-decoration:none;color:red;font-weight:bold;cursor: pointer;" >全部取消</a>' +
            '</div>',
    ...
    SWFUploader.prototype = {
        ...
        startUpload: function (url, postVars, fileFieldName) {
            if (this.get("uploader")) {
                var uploader = this.get("uploader"), fileFieldName = fileFieldName || "FileData", id = this.get("id"),
    ...
    StreamProvider.prototype = {
        ...
        traverseFileTree: function (directory, callback) {
            ...
            callback.pending++;
            var self = this, relativePath = directory.fullPath.replace(/^\//, "").replace(/(.+?)\/?$/, "$1/"),
    ...
    StreamUploader.prototype = {
        ...
        formUpload: function () {
            ...
            var fd = new FormData, fileFileName = this.get("fileFieldName"),
                url = this.get("uploadURL").split('?')[0] + "/postStream?" + this.get("uploadURL").split('?')[1],

                _xhr = this.XHR, _upload = _xhr.upload;
        ...
        streamUpload: function (pos) {
            ...
            var _url = this.get("uploadURL").split('?')[0] + "/postStream?" + this.get("uploadURL").split('?')[1] + "&" + fGetRandom();
            // var _url =  this.get("uploadURL").split("?")[0] + "/getStream?" + this.get("uploadURL").split("?")[1] + "&" + fGetRandom() ;
                ...
                case "load":
                    ...
                    try {
                        if (xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 308)) {
                            ...
                            uploaded = (respJson = data) ? respJson.start : -1;
    ...
    Main.prototype = {
        ...
        initializer: function () {
            ...
            if (!this.config.customered) {
                ...
                cancelQueue = fCreateContentEle(cancelContainer);
                filesQueuePanel.appendChild(cancelQueue);
        ...
        showBrowseBlock: function () {
            ...
            if (this.browseFileBlockDisplay == "none") {
                this.browseFileBlockDisplay = "block", this.browseFileBlockWidth = null, this.browseFileBlockHeight = null;
                return !1;
            }
        ...
        upload: function (index) {
            ...
            //  xhr.open("GET", "http://localhost:8088/tk/getToken?name=vuex%E6%A6%82%E5%BF%B5%E5%9B%BE.png&type=image%2Fpng&size=27326&modified=Wed+Apr+11+2018+17%3A51%3A17+GMT%2B0800+(%E4%B8%AD%E5%9B%BD%E6%A0%87%E5%87%86%E6%97%B6%E9%97%B4)&param1=null&param2=&param3=&param4=&param5=&prarm6=&param7=null&param6=&20422", !0);
            /** IE7,8 兼容*/
