...
!function (i) {
    ...
    u.prototype = {
        constructor: u, init: function () {
            ...
            t = Number(t) || 0, !this.isShown || this.isPlayed || 0 > t || t >= this.length ||
            this.isViewed && t === this.index || this.trigger(Z).isDefaultPrevented() ||
            (s = this.$items.eq(t), n = s.find(E), o = n.data("originalUrl"), a = n.attr("alt"), this.$image = e = i('<img src="' + o + '" alt="' + a + '">'),
                this.$items.eq(this.index).removeClass(k), s.addClass(k), this.isViewed = !1, this.index = t, this.image = null,
                this.$canvas.html(imageMess),
                this.$canvas.append(e.addClass(I)), this.renderList(), h.empty(), this.$element.one(K, i.proxy(function () {
